...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.scraper.first.ScraperSpringApplicationTests", () -> new AotSpringBootConfigContextLoader(ScraperSpringApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.scraper.first.ScraperSpringApplicationTests", ScraperSpringApplicationTestsContextInitializer.class);
    return entries;
  }
}
